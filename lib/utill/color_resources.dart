...
class ColorResources {
  ...
  static Color getPrimary(BuildContext context) {
    return Provider.of<ThemeProvider>(context).darkTheme
        ? Color(0xFFf0f0f0)
        : Colors.orange /*Color(0xFF1B7FED)*/;
  }
  ...
  static const Color COLOR_BLUE = Colors.orange /*Color(0xff00ADE3)*/;
  static const Color COLUMBIA_BLUE = Colors.orange /*Color(0xff00ADE3)*/;
