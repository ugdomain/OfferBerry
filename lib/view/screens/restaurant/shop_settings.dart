                    ...
                    child: Stack(
                      ...
                      children: [
                        ClipRRect(
                          ...
                          child: shopProvider != null && shopProvider.file! == null
                              ? ClipRRect(
                            borderRadius: BorderRadius.circular(50),
                  ...
                  onPressed: () async {
                    ...
                    if (shopProvider.shopModel!.name == _firstName &&
                      ...
                      if (_responseModel.isSuccess) {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Updated Successfully'), duration: Duration(milliseconds: 600),backgroundColor: Colors.green));
                      } else {
