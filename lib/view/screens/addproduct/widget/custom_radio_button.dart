  ...
  Widget build(BuildContext context) {
    return Builder(builder: (context) {
      ...
      return Row(
        children: [
          ..._attrController
              .attrList.first.attrs![widget.index!].controlOptions!
              .map((e) {
            itemIndex++;
            if (_attrController.radioButtonMap.isEmpty ||
              ...
              _attrController.radioButtonMap.addAll(Map.from({
                _attrController
                    ...
                    _attrController
                        .attrList.first.attrs![widget.index!].controlOptions![0]
              }));
            }
            ...
            return Padding(
              ...
              child: TextButton(
                  onPressed: () {
                    setState(() {
                      itemIndex = 0;
                      var controlName = _attrController
                          .attrList.first.attrs![widget.index!].controlName;
                      value = map[e];
                      var selectedValue = map.keys
                          .firstWhere((element) => map[element] == value);
                      if (_attrController.radioButtonMap
                          .containsKey(controlName)) {
                        _attrController.radioButtonMap[controlName] =
                            selectedValue;
                      } else {
                        _attrController.radioButtonMap
                            .addAll(Map.from({controlName: selectedValue}));
                      }
                    });
                  },
                  style: ButtonStyle(
                    backgroundColor: MaterialStateProperty.all(
                        (value == itemIndex) ? Colors.blue : Colors.grey),
                  ),
                  child: Text(e,
                      style: TextStyle(
                        color: Colors.white,
