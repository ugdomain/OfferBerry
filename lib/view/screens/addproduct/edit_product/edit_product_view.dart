...
class EditProductPage extends StatelessWidget {
  EditProductPage({Key? key, required this.category, required this.subCategory, required this.productName,required this.unitPrice, required this.description, required this.attr, required this.images, required this.index})
      : super(key: key,);
...
//=========================================== Sub Category ==============================================>
                        ...
                        EditPageFields().buildStaticInputFields(Theme.of(context).colorScheme.secondary,"${Variables.name[0]}", "${Variables.name[1]}", TextInputType.text,1,ValueKey("ProductName"),productName),
                        Text(
                          "${Variables.unitPrice[0]}",
                          style: titilliumRegular,
                        ),
                        EditPageFields().buildStaticInputFields(Theme.of(context).colorScheme.secondary,"${Variables.unitPrice[0]}", "${Variables.unitPrice[1]}", TextInputType.number,1,ValueKey("unitPrice"),unitPrice),
                        SizedBox(
                          height: 5,
                        ),
                                ...
                                return
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child:
                                        buildEditInputFields(index,key: ValueKey("${_attrController.attrList[0].attrs![index].controlName}"),
                                          value: attr[_attrController.attrList[0].attrs![index].controlName],),
                                      )],
                                  ):
                                  _attrController.attrList[0].attrs![index].control ==
                                      "radio" ?
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      // SizedBox(height: 3,),
                                      Obx(()=> CustomRadioButton(index: index,
                                          radiokey: ValueKey("${_attrController.attrList[0].attrs![index].controlName}",
                                          )),
                                      ),
                                      SizedBox(height: 15,)
                                    ],
                        ...
                        EditPageFields().buildDescriptionField(Theme.of(context).colorScheme.secondary,"${Variables.description[0]}", "${Variables.description[1]}", TextInputType.text,5,ValueKey("${Variables.description[1]}"),description),
...
//================================ Buttons =====================================>
                        EditPageFields().buildButton(context, "Edit", () {
                          ...
                          if (_categoryController.isValidated.value) {
                            ...
                            _fieldsController.editDataInList(_fieldsController.jsonMap,index);
                            _categoryController.editDataInUiList(index,
                                _categoryController.submit);
                            Get.back();
                            Get.snackbar("Success", "Data Edited Successfully!");
                          }
                        }),
                      ],
                    ),
