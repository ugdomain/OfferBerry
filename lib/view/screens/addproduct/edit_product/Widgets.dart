...
class EditPageFields{
  ...
  Widget buildStaticInputFields(Color? color,String name, String jsonName, TextInputType type,int maxLine,ValueKey key,String value) {
    return Container(
  ...
  Widget buildDescriptionField(Color? color,String name, String jsonName, TextInputType type,int maxLine, ValueKey key,String value) {
    return Container(
      width: double.infinity,
      decoration: BoxDecoration(
        color: color,
