...
class ShowListOfImages extends StatelessWidget {
  ShowListOfImages({Key? key, required this.listOfImages, required this.index})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return ConstrainedBox(
      constraints: BoxConstraints(
          minWidth: 390, minHeight: 150, maxHeight: 400, maxWidth: 420),
              ...
              () => _updateListViewImageController.isImageListUpdated.value
                  ? GestureDetector(
                      onLongPress: () {
                        ...
                        Get.bottomSheet(ListViewImageOperationSelectionDrawer(
                          index: i,
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                                fit: BoxFit.cover,
                                image: FileImage(listOfImages[index][i]))),
                      ))
                  : GestureDetector(
                      onLongPress: () {
                        Get.bottomSheet(ListViewImageOperationSelectionDrawer(
