  ...
  Future<http.StreamedResponse> updateProfile(SellerModel userInfoModel,
    ...
    if (file != null) {
      ...
      _fields.addAll(<String, String>{
        '_method': 'put',
        'f_name': userInfoModel.fName.toString(),
        'l_name': userInfoModel.lName.toString(),
        'phone': userInfoModel.phone.toString(),
        'bank_name': seller.bankName.toString(),
        'branch': seller.branch.toString(),
        'holder_name': seller.holderName.toString(),
        'account_no': seller.accountNo.toString(),
      });
    } else {
      _fields.addAll(<String, String>{
        '_method': 'put',
